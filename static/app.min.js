(function(e,q,g){try{var l,h,b,c,f,r,m=0,w=100,t,p=e.getElementById("cms-graph"),u=e.getElementById("loader"),d=e.getElementsByTagName("noscript")[0],k=e.getElementById("psa"),y=e.getElementById("js-refresh"),n=function(a,b){u.style.display="block";e.getElementById("loader-content").style.display="none";(d=e.getElementById("loader-error")).style.display="block";a?(d.innerHTML=a,a=a.replace("<br>"," ")):a="AJAX Error: "+b;ga&&ga("send","event","Error","ShowError",a)},v=function(){0>=m?(m=45,z()):(setTimeout(v,
1E3),y.textContent=10>--m?"0"+m:m)},z=function(){u.style.display="block";c=new XMLHttpRequest;c.open("GET","https://steamdb.info/api/SteamRailgun/",!0);c.onreadystatechange=A;c.ontimeout=function(){n("Request timed out.<br>Reload the page manually.")};c.timeout=2E4;c.send()},A=function(){c=this;if(4===c.readyState){b=c.responseText;try{u.style.display="none";if(200!==c.status)return n("","Status: "+c.status);if(null===b||"{"!==b[0])return n("Received invalid data.<br>Is something wrong with your network?");
...
tickPositions:[0,25,50,75,100],min:0,max:100,allowDecimals:!1,startOnTick:!1,endOnTick:!1},series:[{pointStart:a.getTime(),pointInterval:3E4,data:t,marker:{enabled:!1},states:{hover:{enabled:!1}}}]});t=null}else p.innerHTML="Failed to load Highcharts.<br>Please unblock <b>cdnjs.cloudflare.com</b> for this to work."};"serviceWorker"in navigator&&navigator.serviceWorker.register("/static/service-worker.js")}catch(x){n("Something broke.<br>Are you using an outdated browser?"),ga&&ga("send","event","Error",
"ShowError",x.message||"try-catch"),console.error(x)}})(document,localStorage,window.Notification);
